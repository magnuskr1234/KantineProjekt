...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "kantine_v2" because\n';
  ...
  $wnd.__gwt_activeModules['kantine_v2'] = {
    'moduleName' : 'kantine_v2',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/kantine_v2.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['kantine_v2'].superdevmode = true;

  var expectedSuffix = '/kantine_v2.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + kantine_v2 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:kantine_v2';
  var devModeSessionKey = '__gwtDevModeSession:kantine_v2';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/kantine_v2/kantine_v2.nocache.js';
  ...
  $wnd.__gwt_activeModules['kantine_v2'].canRedirect = true;
  $wnd.__gwt_activeModules['kantine_v2'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/kantine_v2?user.agent=' + ua + '&_callback=' + callback;
